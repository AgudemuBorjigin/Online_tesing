...
# -*- coding: utf-8 -*-
"""
Created on Tue Jul 21 23:50:43 2020
...
folderName_local = 'wavFiles'  # 'wavFilesDemo2', 'wavFiles', 'wavFilesDemo'
jsonName = 'trials_main_ILD.json' # 'trials_demo_ILD.json', 'trials_main_ILD.json', 'trials_demo_ILD_2.json'
taskType = '' # 'd', '', 'd_2'
...
if taskType == 'd':
    data['volume'] = [{
        ...
        "stimulus": "https://speech-in-noise-test.s3.us-east-2.amazonaws.com/audios/ILD/demo/volume.wav",
    ...
    data['volume'] = [{
        ...
        "plugin": "hari-audio-button-response",
        "prompt": "Now adjust your computer volume up to a comfortable (but not too loud) level.",
        "stimulus": "https://speech-in-noise-test.s3.us-east-2.amazonaws.com/audios/ILD/demo_2/volume.wav",
        "choices": ["I have adjusted the volume, let's continue"]
        }]
else:
    data['volume'] = [{
...
fileURLroot = "https://speech-in-noise-test.s3.us-east-2.amazonaws.com/audios/ILD/" + folderName_URL + "/"
fileDirCSV = "/Users/Agudemu/Dropbox/Lab_SNAP/Experiment/stimulus-TFS/stage-2/peripheral/ILD/" + folderName_local + "/fileNames.csv"
