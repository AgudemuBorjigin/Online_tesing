...
%% residual
mdl_FM = stepwiselm(thresh_ILD, thresh_FM);
mdl_ITD = stepwiselm(thresh_ILD, thresh_ITD);
mdl_ILD = stepwiselm([thresh_ITD', thresh_FM'], thresh_ILD');
% fitlm
...
savename = '/Users/Agudemu/Dropbox/Lab_SNAP/Experiment/online_experiments/snaplabonline/analysis/psignifit/TFS_beforeGrouping.mat';
save(savename, 'resid_ITD', 'resid_FM', 'resid_ILD', 'data_FM', 'data_ILD', 'data_ITD', 'thresh_ITD', 'thresh_FM', 'thresh_ILD', ...
